...
define([
    ...
    var DevtoolsView = Backbone.View.extend({
        ...
        events:{
            ...
            'change .chatboxSpeed input':'onChatboxSpeedToggle',
        ...
        _checkChatboxVisibility: function() {
            if (!Adapt.componentStore.chatbox) return;
            this.$('.toggle.chatboxSpeed').removeClass('display-none');
        },

        onChatboxSpeedToggle: function() {
            Adapt.devtools.toggleChatboxSpeed();
            this.$('.toggle.chatboxSpeed label').toggleClass('selected', Adapt.devtools.get('_chatBoxSpeedEnabled'));
